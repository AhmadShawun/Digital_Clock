...
lab_hr_text.place(x=35,y=175,height=40,width=120)
...
lab_min_text = Label(clock,text='Minutes',font=('Ga Maamli',20,'bold'), bg='#b50b41',fg='white') # for hour (class,)
lab_min_text.place(x=250,y=175,height=40,width=120)
...
lab_sec_text.place(x=450,y=175,height=40,width=120)

lab_am = Label(clock,text='00',font=('Ga Maamli',40,'bold'), bg='#b50b41',fg='white') # for min (class,)
lab_am.place(x=650,y=35,height=120,width=120)

lab_am_text = Label(clock,text='Am/Pm',font=('Ga Maamli',20,'bold'), bg='#b50b41',fg='white',) # for hour (class,)
lab_am_text.place(x=650,y=175,height=40,width=120)
...
lab_date_text.place(x=35,y=275,height=40,width=120)
...
lab_mo_text.place(x=250,y=275,height=40,width=120)
...
lab_year_text.place(x=450,y=275,height=40,width=120)

lab_day = Label(clock,text='00',font=('Ga Maamli',40,'bold'), bg='#b50b41',fg='white') # for Day (class,)
...
lab_day_text.place(x=650,y=275,height=40,width=120)
